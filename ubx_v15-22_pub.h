 ...
 * Audience: PUB
 *
 * Supported Protocol Versions: 15-18,22
 *
...
#ifndef __PROTO_UBX_STRUCT_DEF_H_20BCCD0D_3F3694D8
#define __PROTO_UBX_STRUCT_DEF_H_20BCCD0D_3F3694D8
...
//================================================================
//! ESF_INS_DATA1: Periodic/Polled
/*!
Vehicle dynamics information
This message outputs information about vehicle dynamics computed by the Inertial Navigation System (INS) during ESF-based navigation.
For ADR products, the output dynamics information (angular rates and accelerations) is expressed with respect to the <r href=\"ESF-ADR-VEHICLEFRAME'>vehicle-frame</r>. More information can be found in the <r href=\"ESF-ADR-OUTPUT'>ADR Navigation Output</r> section.


This message's id is #UBXID_ESF_INS
*/
//================================================================

typedef struct UBX_ESF_INS_DATA1_s
{
    U4  bitfield0;                //!< Bitfield
    ...
    I4  xAngRate;                 //!< Compensated x-axis angular rate.
    I4  yAngRate;                 //!< Compensated y-axis angular rate.
    I4  zAngRate;                 //!< Compensated z-axis angular rate.
    I4  xAccel;                   //!< Compensated x-axis acceleration (gravity-free).
    I4  yAccel;                   //!< Compensated y-axis acceleration (gravity-free).
    I4  zAccel;                   //!< Compensated z-axis acceleration (gravity-free).

} UBX_ESF_INS_DATA1_t, *UBX_ESF_INS_DATA1_pt;


//! \name Bit Definitions for #UBX_ESF_INS_DATA1_s::bitfield0
//@{
#define UBX_ESF_INS_DATA1_BITFIELD0_VERSION_MASK 0x00FF  //!< Mask for field version in bitmask bitfield0
#define UBX_ESF_INS_DATA1_BITFIELD0_VERSION_GET(val)  (U)(((val)&UBX_ESF_INS_DATA1_BITFIELD0_VERSION_MASK)>>0)  //!< Get version from bitmask bitfield0
#define UBX_ESF_INS_DATA1_BITFIELD0_XANGRATEVALID_MASK 0x0100  //!< Mask for field xAngRateValid in bitmask bitfield0
#define UBX_ESF_INS_DATA1_BITFIELD0_XANGRATEVALID_GET(val)  (U)(((val)&UBX_ESF_INS_DATA1_BITFIELD0_XANGRATEVALID_MASK)>>8)  //!< Get xAngRateValid from bitmask bitfield0
#define UBX_ESF_INS_DATA1_BITFIELD0_YANGRATEVALID_MASK 0x0200  //!< Mask for field yAngRateValid in bitmask bitfield0
#define UBX_ESF_INS_DATA1_BITFIELD0_YANGRATEVALID_GET(val)  (U)(((val)&UBX_ESF_INS_DATA1_BITFIELD0_YANGRATEVALID_MASK)>>9)  //!< Get yAngRateValid from bitmask bitfield0
#define UBX_ESF_INS_DATA1_BITFIELD0_ZANGRATEVALID_MASK 0x0400  //!< Mask for field zAngRateValid in bitmask bitfield0
#define UBX_ESF_INS_DATA1_BITFIELD0_ZANGRATEVALID_GET(val)  (U)(((val)&UBX_ESF_INS_DATA1_BITFIELD0_ZANGRATEVALID_MASK)>>10)  //!< Get zAngRateValid from bitmask bitfield0
#define UBX_ESF_INS_DATA1_BITFIELD0_XACCELVALID_MASK 0x0800  //!< Mask for field xAccelValid in bitmask bitfield0
#define UBX_ESF_INS_DATA1_BITFIELD0_XACCELVALID_GET(val)  (U)(((val)&UBX_ESF_INS_DATA1_BITFIELD0_XACCELVALID_MASK)>>11)  //!< Get xAccelValid from bitmask bitfield0
#define UBX_ESF_INS_DATA1_BITFIELD0_YACCELVALID_MASK 0x1000  //!< Mask for field yAccelValid in bitmask bitfield0
#define UBX_ESF_INS_DATA1_BITFIELD0_YACCELVALID_GET(val)  (U)(((val)&UBX_ESF_INS_DATA1_BITFIELD0_YACCELVALID_MASK)>>12)  //!< Get yAccelValid from bitmask bitfield0
#define UBX_ESF_INS_DATA1_BITFIELD0_ZACCELVALID_MASK 0x2000  //!< Mask for field zAccelValid in bitmask bitfield0
#define UBX_ESF_INS_DATA1_BITFIELD0_ZACCELVALID_GET(val)  (U)(((val)&UBX_ESF_INS_DATA1_BITFIELD0_ZACCELVALID_MASK)>>13)  //!< Get zAccelValid from bitmask bitfield0

//@}

#define UBXID_ESF_INS 0x1015 //!< message id for ESF-INS
...
This message's id is #UBXID_HNR_PVT
*/
//================================================================

typedef struct UBX_HNR_PVT_DATA0_s
{
    U4  iTOW;                     //!< GPS time of week of the <r href=\"NAV-EPOCH-DESC'>navigation epoch</r>.
    U2  year;                     //!< Year (UTC)
    ...
    U4  hAcc;                     //!< Horizontal accuracy
    U4  vAcc;                     //!< Vertical accuracy
    U4  sAcc;                     //!< Speed accuracy
    U4  headAcc;                  //!< Heading accuracy
    U1  reserved2[4];             //!< <r href='DESC-UBX-Reserved'>Reserved</r>

} UBX_HNR_PVT_DATA0_t, *UBX_HNR_PVT_DATA0_pt;


//! \name Bit Definitions for #UBX_HNR_PVT_DATA0_s::valid
//@{
#define UBX_HNR_PVT_DATA0_VALID_VALIDDATE_MASK 0x01  //!< Mask for field validDate in bitmask valid
#define UBX_HNR_PVT_DATA0_VALID_VALIDDATE_GET(val)  (U)(((val)&UBX_HNR_PVT_DATA0_VALID_VALIDDATE_MASK)>>0)  //!< Get validDate from bitmask valid
#define UBX_HNR_PVT_DATA0_VALID_VALIDTIME_MASK 0x02  //!< Mask for field validTime in bitmask valid
#define UBX_HNR_PVT_DATA0_VALID_VALIDTIME_GET(val)  (U)(((val)&UBX_HNR_PVT_DATA0_VALID_VALIDTIME_MASK)>>1)  //!< Get validTime from bitmask valid
#define UBX_HNR_PVT_DATA0_VALID_FULLYRESOLVED_MASK 0x04  //!< Mask for field fullyResolved in bitmask valid
#define UBX_HNR_PVT_DATA0_VALID_FULLYRESOLVED_GET(val)  (U)(((val)&UBX_HNR_PVT_DATA0_VALID_FULLYRESOLVED_MASK)>>2)  //!< Get fullyResolved from bitmask valid

//@}
//! \name Bit Definitions for #UBX_HNR_PVT_DATA0_s::flags
//@{
#define UBX_HNR_PVT_DATA0_FLAGS_GPSFIXOK_MASK 0x01  //!< Mask for field GPSfixOK in bitmask flags
#define UBX_HNR_PVT_DATA0_FLAGS_GPSFIXOK_GET(val)  (U)(((val)&UBX_HNR_PVT_DATA0_FLAGS_GPSFIXOK_MASK)>>0)  //!< Get GPSfixOK from bitmask flags
#define UBX_HNR_PVT_DATA0_FLAGS_DIFFSOLN_MASK 0x02  //!< Mask for field DiffSoln in bitmask flags
#define UBX_HNR_PVT_DATA0_FLAGS_DIFFSOLN_GET(val)  (U)(((val)&UBX_HNR_PVT_DATA0_FLAGS_DIFFSOLN_MASK)>>1)  //!< Get DiffSoln from bitmask flags
#define UBX_HNR_PVT_DATA0_FLAGS_WKNSET_MASK 0x04  //!< Mask for field WKNSET in bitmask flags
#define UBX_HNR_PVT_DATA0_FLAGS_WKNSET_GET(val)  (U)(((val)&UBX_HNR_PVT_DATA0_FLAGS_WKNSET_MASK)>>2)  //!< Get WKNSET from bitmask flags
#define UBX_HNR_PVT_DATA0_FLAGS_TOWSET_MASK 0x08  //!< Mask for field TOWSET in bitmask flags
#define UBX_HNR_PVT_DATA0_FLAGS_TOWSET_GET(val)  (U)(((val)&UBX_HNR_PVT_DATA0_FLAGS_TOWSET_MASK)>>3)  //!< Get TOWSET from bitmask flags
#define UBX_HNR_PVT_DATA0_FLAGS_HEADVEHVALID_MASK 0x10  //!< Mask for field headVehValid in bitmask flags
#define UBX_HNR_PVT_DATA0_FLAGS_HEADVEHVALID_GET(val)  (U)(((val)&UBX_HNR_PVT_DATA0_FLAGS_HEADVEHVALID_MASK)>>4)  //!< Get headVehValid from bitmask flags

//@}

#define UBXID_HNR_PVT 0x2800 //!< message id for HNR-PVT
...
//================================================================
//! NAV_ATT_DATA0: Periodic/Polled
/*!
Attitude Solution
This message outputs the attitude solution as roll, pitch and heading angles.
More details about vehicle attitude can be found in the <r href=\"ESF-ADR-ATTITUDE'>Vehicle Attitude Output (ADR)</r> section for ADR products.


This message's id is #UBXID_NAV_ATT
*/
//================================================================

typedef struct UBX_NAV_ATT_DATA0_s
{
    U4  iTOW;                     //!< GPS time of week of the <r href=\"NAV-EPOCH-DESC'>navigation epoch</r>.
    U1  version;                  //!< Message version (0 for this version)
    U1  reserved1[3];             //!< <r href='DESC-UBX-Reserved'>Reserved</r>
    I4  roll;                     //!< Vehicle roll.
    I4  pitch;                    //!< Vehicle pitch.
    I4  heading;                  //!< Vehicle heading.
    U4  accRoll;                  //!< Vehicle roll accuracy (if null, roll angle is not available).
    U4  accPitch;                 //!< Vehicle pitch accuracy (if null, pitch angle is not available).
    U4  accHeading;               //!< Vehicle heading accuracy (if null, heading angle is not available).

} UBX_NAV_ATT_DATA0_t, *UBX_NAV_ATT_DATA0_pt;


#define UBXID_NAV_ATT 0x0105 //!< message id for NAV-ATT
